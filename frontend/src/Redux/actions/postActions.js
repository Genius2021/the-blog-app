...
export const createNewPost = (title, description, picture, username, category) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axiosInstance.post("/posts", { title, description, picture, username, categories: category });
        console.log("succeeded")
        await axiosInstance.post("/category", { name: category, postId: data._id, username });
...
export const editPost = (title, id, description, username) => async (dispatch) => {
    ...
    try {
        const { data } = await axiosInstance.put(`/posts/${id}`, { username, title, description });
